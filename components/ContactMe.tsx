...
function ContactMe({}:Props) {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        window.location.href = `mailto:devkapsakrisz@gmail.com@gmail.com.         ?subject=${formData.subject}&body=Hi my name is ${formData.name}. ${formData.message} (${formData.email})`;
    }
        ...
        md:flex-row max-w-3xl px-2 justify-evenly mx-auto items-center">
            ...
            <div className="flex flex-col space-y-8">
                <h4 className="text-1xl font-semibold text-center mt-8">
                    ...
                    <p className="text-1xl">devkapsakrisz@gmail.com@gmail.com         </p>
                        </div>
